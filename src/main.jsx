...
const TOOLS = [
    ...
    },
    {
        ...
        description: 'Browser-only source-note builder for Data.gov, National Archives Catalog API, and OAI-PMH.',
                        ...
                        <nav className="space-y-2" aria-label="Interactive tools">
                            {filteredTools.map(tool => (
                                <button
                                    ...
                                    className={`w-full rounded-lg border p-3 text-left transition ${selected === tool.id
